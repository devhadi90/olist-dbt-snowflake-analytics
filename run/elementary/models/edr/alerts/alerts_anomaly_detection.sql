  ...
  create or replace   view olist_analytics.staging_deploy.alerts_anomaly_detection
...
with
    elementary_test_results as (select * from olist_analytics.staging_deploy.elementary_test_results),
