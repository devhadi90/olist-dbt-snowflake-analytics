  ...
  create or replace   view olist_analytics.staging_deploy.metrics_anomaly_score
...
with
    data_monitoring_metrics as (select * from olist_analytics.staging_deploy.data_monitoring_metrics),
