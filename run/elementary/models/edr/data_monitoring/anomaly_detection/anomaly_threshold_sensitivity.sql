  ...
  create or replace   view olist_analytics.staging_deploy.anomaly_threshold_sensitivity
...
with
    metrics_anomaly_score as (select * from olist_analytics.staging_deploy.metrics_anomaly_score),
